...
class ViewUtils {
    ...
    @NonNull
    public static TypedValue getThemeAccentColor(@NonNull Context context) {
    ...
    @NonNull
    public static TypedValue getThemeColorControlNormal(@NonNull Context context) {
        @IdRes final int colorAttr;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    @NonNull
    public static TypedValue getThemeTextColorSecondary(@NonNull Context context) {
        @IdRes final int colorAttr;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    @NonNull
    public static TypedValue getThemeTextColorPrimary(@NonNull Context context) {
        @IdRes final int colorAttr;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    @NonNull
    public static Drawable getTintedIconWithAttribute(
            @NonNull Context context,
    ...
    public static boolean isCvcMaximalLength(@NonNull @Card.CardBrand String cardBrand,
